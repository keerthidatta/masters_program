...
if __name__ == '__main__':
	...
	meas_thread = threading.Thread(target=PublishEncValues, args=(pub1, pub2, pub3, pub4, pub5, pub6,))
	#meas_thread.start()
	#AccessRoboclaw()
	...
	while not rospy.is_shutdown():
		...
		MoveRover(leftwheel,centerleftwheel, rearleftwheel, rightwheel, centerrightwheel,rearrightwheel)
		speeds = []
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_FRONT_LEFT))
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_FRONT_RIGHT))
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_CENTER_LEFT))
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_CENTER_RIGHT))
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_BACK_LEFT))
		speeds.append(GetEncSpeed(MotorSelect.WHEEL_BACK_RIGHT))

		speeds.append(GetEncRover(MotorSelect.STEERING_FRONT_LEFT))
		speeds.append(GetEncRover(MotorSelect.STEERING_FRONT_RIGHT))
		speeds.append(GetEncRover(MotorSelect.STEERING_BACK_LEFT))
		speeds.append(GetEncRover(MotorSelect.STEERING_BACK_RIGHT))

		speeds.append(GetEncRover(MotorSelect.CAM_PAN))
		speeds.append(GetEncRover(MotorSelect.CAM_TILT))
		
		#SetPosPID(MotorSelect.WHEEL_FRONT_LEFT, pan_pos)
		#SetPosPID(MotorSelect.WHEEL_FRONT_RIGHT, pan_pos)
		#keyboard_control(MotorSelect.CAM_PAN, 50)
		
		ReadEncodersTest()
		#print speeds
		#StopRover()
		#CalibrateAbsoluteEncoders()
		# enc = GetEncRover(MotorSelect.STEERING_FRONT_RIGHT)
		# if enc[1] != 0:
		#	print enc
		#speedmsg = roboclaw.ReadSpeedM1(128)
		#if speedmsg[0] == 1:
		#	print "current speed: " + str(speedmsg[1])
		#ReadIncrementalEncoders()
		#time.sleep(5)
		# ReadEncodersTest()
